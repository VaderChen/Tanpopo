(() => {
  ...
  const rows = [
    ...
    ["模型下載分類", "Model download sections", "モデルダウンロード分類", "모델 다운로드 분류"],
    ["下載中心", "Download center", "ダウンロードセンター", "다운로드 센터"],
    ["新增模型與查看下載進度", "Add models and view download progress", "モデルの追加とダウンロード進捗", "모델 추가 및 다운로드 진행 상황"],
    ["已下載模型", "Downloaded models", "ダウンロード済みモデル", "다운로드한 모델"],
    ["依 MLX、GGUF 格式瀏覽", "Browse by MLX and GGUF format", "MLX・GGUF 形式別に表示", "MLX 및 GGUF 형식별 보기"],
    ["列出目前模型目錄中可辨識的 MLX 與 GGUF 模型。", "Lists recognizable MLX and GGUF models in the configured model folders.", "設定されたモデルフォルダー内で認識可能な MLX・GGUF モデルを表示します。", "설정된 모델 폴더에서 인식 가능한 MLX 및 GGUF 모델을 표시합니다."],
    ["個模型", "models", "モデル", "개 모델"],
    ["尚未下載模型", "No models downloaded yet", "ダウンロード済みのモデルはありません", "아직 다운로드한 모델이 없습니다"],
    ["下載完成後會顯示在這裡。", "Downloaded models will appear here.", "ダウンロードが完了すると、ここに表示されます。", "다운로드가 완료되면 여기에 표시됩니다."],
    ["修改於", "Modified", "更新", "수정"],
    ["確定要刪除此模型嗎？模型檔案將從硬碟移除，且無法復原。", "Delete this model? Its files will be removed from disk and cannot be recovered.", "このモデルを削除しますか？モデルファイルはディスクから削除され、元に戻せません。", "이 모델을 삭제하시겠습니까? 모델 파일이 디스크에서 제거되며 복구할 수 없습니다."],
    ["確定要刪除此模型的完整目錄嗎？目錄內所有檔案都會從硬碟移除，且無法復原。", "Delete this model's entire directory? Every file in the directory will be removed from disk and cannot be recovered.", "このモデルのディレクトリ全体を削除しますか？ディレクトリ内の全ファイルがディスクから削除され、元に戻せません。", "이 모델의 전체 디렉터리를 삭제하시겠습니까? 디렉터리 안의 모든 파일이 디스크에서 제거되며 복구할 수 없습니다."],
    ["刪除中…", "Deleting…", "削除しています…", "삭제하는 중…"],
    ["模型已刪除", "Model deleted", "モデルを削除しました", "모델을 삭제했습니다"],
    ["移除 Fast GGUF", "Remove Fast GGUF", "Fast GGUF を削除", "Fast GGUF 제거"],
    ["確定要移除此模型的 Fast GGUF 嗎？原始 GGUF 與模型目錄不會刪除；下次以 MLX 載入時需要重新建立 Fast GGUF。", "Remove this model's Fast GGUF? The original GGUF and model directory will be kept; Fast GGUF must be rebuilt the next time MLX loads it.", "このモデルの Fast GGUF を削除しますか？元の GGUF とモデルディレクトリは保持されます。次回 MLX で読み込む際に Fast GGUF の再構築が必要です。", "이 모델의 Fast GGUF를 제거하시겠습니까? 원본 GGUF와 모델 디렉터리는 유지되며 다음 MLX 로드 시 Fast GGUF를 다시 만들어야 합니다."],
    ["正在移除 Fast GGUF…", "Removing Fast GGUF…", "Fast GGUF を削除しています…", "Fast GGUF를 제거하는 중…"],
    ["Fast GGUF 已移除", "Fast GGUF removed", "Fast GGUF を削除しました", "Fast GGUF를 제거했습니다"],
    ...
    ["準備中…", "Preparing…", "準備しています…", "준비하는 중…"],
    ["模型準備進度", "Model preparation progress", "モデル準備の進捗", "모델 준비 진행률"],
    ["模型組裝進度", "Model assembly progress", "モデル構築の進捗", "모델 구성 진행률"],
    ["清除", "Clear", "消去", "지우기"],
    ["取消", "Cancel", "キャンセル", "취소"],
    ["約", "About", "約", "약"],
    ["新增", "Add", "追加", "추가"],
    ...
    ["部分模型可能需要轉換，請耐心等候。", "Some models may require conversion. Please wait patiently.", "一部のモデルは変換が必要な場合があります。しばらくお待ちください。", "일부 모델은 변환이 필요할 수 있습니다. 잠시 기다려 주세요."],
    ["模型需要轉換", "Model conversion required", "モデルの変換が必要です", "모델 변환 필요"],
    ["本次啟動找不到可重用的 Fast GGUF。轉換完成後會永久保存權重，避免下次重新轉換。", "No reusable Fast GGUF was found for this launch. Converted weights will be stored persistently to avoid reconversion next time.", "今回の起動で再利用可能な Fast GGUF が見つかりません。変換済みウェイトは永続保存され、次回の再変換を回避します。", "이번 실행에 재사용 가능한 Fast GGUF가 없습니다. 변환된 가중치는 영구 저장되어 다음 실행에서 다시 변환하지 않습니다."],
    ["不建立 Fast GGUF 直接啟動", "Start without creating Fast GGUF", "Fast GGUF を作成せず起動", "Fast GGUF를 만들지 않고 시작"],
    ["選擇「不建立 Fast GGUF 直接啟動」不會寫入 Fast GGUF；GGUF 權重仍會在記憶體中即時準備為 MLX 可執行格式，下次啟動會再次處理。", "Starting without creating Fast GGUF does not write converted weights to disk. GGUF weights are still prepared in memory for MLX execution and must be processed again on the next launch.", "「Fast GGUF を作成せず起動」を選ぶと変換済みウェイトはディスクに書き込まれません。GGUF ウェイトは MLX 実行用にメモリ内で準備され、次回起動時に再処理されます。", "Fast GGUF를 만들지 않고 시작하면 변환된 가중치를 디스크에 기록하지 않습니다. GGUF 가중치는 MLX 실행을 위해 메모리에서 준비되며 다음 실행 때 다시 처리됩니다."],
    ["預估新增硬碟容量", "Estimated additional disk space", "追加ディスク容量の見積もり", "예상 추가 디스크 용량"],
    ["實際容量可能因權重形狀與檔案系統配置略有差異。", "Actual usage may vary slightly with tensor shapes and filesystem allocation.", "実際の容量はウェイト形状やファイルシステムの割り当てにより多少異なる場合があります。", "실제 용량은 가중치 형태와 파일 시스템 할당에 따라 조금 달라질 수 있습니다."],
    ["轉換並啟動", "Convert and start", "変換して起動", "변환 후 시작"],
    ["正在檢查 Fast GGUF", "Checking Fast GGUF", "Fast GGUF を確認しています", "Fast GGUF를 확인하는 중"],
    ["正在確認此模型是否已有可重用的轉換權重。", "Checking whether reusable converted weights already exist for this model.", "このモデルに再利用可能な変換済みウェイトがあるか確認しています。", "이 모델에 재사용 가능한 변환 가중치가 있는지 확인하는 중입니다."],
    ["正在轉換模型", "Converting model", "モデルを変換しています", "모델을 변환하는 중"],
    ["此模型需要轉換並建立 Fast GGUF；完成前請勿關閉程式。", "This model must be converted to Fast GGUF. Do not close the application until it finishes.", "このモデルは Fast GGUF への変換が必要です。完了するまでアプリを閉じないでください。", "이 모델은 Fast GGUF로 변환해야 합니다. 완료될 때까지 앱을 종료하지 마세요."],
    ["正在建立 Fast GGUF", "Creating Fast GGUF", "Fast GGUF を作成しています", "Fast GGUF를 만드는 중"],
    ["模型已完成轉換，正在寫入 Fast GGUF；後續載入可直接重用。", "Conversion is complete and Fast GGUF is being written. Future loads can reuse it directly.", "変換が完了し、Fast GGUF を書き込んでいます。次回以降は直接再利用できます。", "변환이 완료되어 Fast GGUF를 기록하는 중입니다. 이후 로드에서는 바로 재사용할 수 있습니다."],
    ["正在載入 Fast GGUF", "Loading Fast GGUF", "Fast GGUF を読み込んでいます", "Fast GGUF를 불러오는 중"],
    ["已找到完成的 Fast GGUF，本次不需要重新轉換。", "A completed Fast GGUF was found, so no reconversion is needed this time.", "完成済みの Fast GGUF が見つかったため、今回は再変換しません。", "완성된 Fast GGUF를 찾았으므로 이번에는 다시 변환하지 않습니다."],
    ["正在直接載入模型", "Loading model directly", "モデルを直接読み込んでいます", "모델을 직접 불러오는 중"],
    ["本次不建立 Fast GGUF；正在從 GGUF 即時準備 MLX 執行所需的權重。", "Fast GGUF will not be created. Weights required for MLX execution are being prepared directly from GGUF.", "今回は Fast GGUF を作成しません。GGUF から MLX 実行に必要なウェイトを直接準備しています。", "이번에는 Fast GGUF를 만들지 않습니다. GGUF에서 MLX 실행에 필요한 가중치를 직접 준비하는 중입니다."],
    ...
    ["MLX MTP（Greedy，Block 2）", "MLX MTP (greedy, block 2)", "MLX MTP（Greedy、Block 2）", "MLX MTP(그리디, 블록 2)"],
    ["找不到配對的 MTP Draft，請先下載後再啟用。", "No matching MTP Draft was found. Download one before enabling MTP.", "対応する MTP Draft が見つかりません。先にダウンロードしてください。", "일치하는 MTP Draft를 찾지 못했습니다. 먼저 다운로드하세요."],
    ["找不到配對的 MTP Draft 模型。是否前往「模型下載」？", "No matching MTP Draft model was found. Open Model download?", "対応する MTP Draft モデルが見つかりません。「モデルのダウンロード」を開きますか？", "일치하는 MTP Draft 모델을 찾지 못했습니다. 모델 다운로드로 이동할까요?"],
    ["找不到配對的 DFlash Draft，請先下載後再啟用。", "No matching DFlash Draft was found. Download one before enabling DFlash.", "対応する DFlash Draft が見つかりません。先にダウンロードしてください。", "일치하는 DFlash Draft를 찾지 못했습니다. 먼저 다운로드하세요."],
    ["找不到配對的 DFlash Draft 模型。是否前往「模型下載」？", "No matching DFlash Draft model was found. Open Model download?", "対応する DFlash Draft モデルが見つかりません。「モデルのダウンロード」を開きますか？", "일치하는 DFlash Draft 모델을 찾지 못했습니다. 모델 다운로드로 이동할까요?"],
    ["選定的 Target 模型不支援 MTP，請改用相容的 MLX 模型或內嵌 MTP 的 GGUF。", "The selected Target model does not support MTP. Select a compatible MLX model or a GGUF with embedded MTP weights.", "選択した Target モデルは MTP に対応していません。対応する MLX モデル、または MTP 内蔵 GGUF を選択してください。", "선택한 Target 모델은 MTP를 지원하지 않습니다. 호환되는 MLX 모델 또는 MTP 내장 GGUF를 선택하세요."],
    ["啟動參數已選用 MTP，將使用 GGUF 內嵌預測層。", "MTP is selected and will use the prediction layers embedded in the GGUF.", "MTP が選択されており、GGUF 内蔵の予測レイヤーを使用します。", "MTP가 선택되었으며 GGUF에 내장된 예측 레이어를 사용합니다."],
    ["本次使用 GGUF 內嵌 MTP 預測層。", "This run uses the MTP prediction layers embedded in the GGUF.", "今回は GGUF 内蔵の MTP 予測レイヤーを使用します。", "이번 실행은 GGUF에 내장된 MTP 예측 레이어를 사용합니다."],
    ["MTP 已由啟動參數啟用；兩者不可同時使用。", "MTP is enabled by the launch profile; these features cannot be used together.", "MTP は起動プロファイルで有効です。両方を同時には使用できません。", "MTP가 시작 프로필에서 활성화되어 두 기능을 동시에 사용할 수 없습니다."],
    ["啟用", "On", "オン", "켜기"],
    ["進階設定", "Advanced settings", "詳細設定", "고급 설정"],
    ["設定快速GGUF模式、KV Cache 量化、MMap 與 DFlash。", "Configure Fast GGUF mode, KV Cache quantization, MMap, and DFlash.", "高速 GGUF モード、KV Cache 量子化、MMap、DFlash を設定します。", "빠른 GGUF 모드, KV Cache 양자화, MMap 및 DFlash를 설정합니다."],
    ["快速GGUF模式", "Fast GGUF mode", "高速 GGUF モード", "빠른 GGUF 모드"],
    ["啟用快速GGUF模式", "Enable Fast GGUF mode", "高速 GGUF モードを有効化", "빠른 GGUF 모드 켜기"],
    ["以 INT4、自動 Group 與 recurrent 控制投影 BF16 提高 MLX + GGUF 生成速度；屬實驗模式，可能明顯影響精度。", "Uses INT4, automatic grouping, and BF16 recurrent control projections to speed up MLX + GGUF generation. This is experimental and may materially affect accuracy.", "INT4、自動 Group、recurrent 制御投影の BF16 化で MLX + GGUF の生成を高速化します。実験的な機能であり、精度に大きく影響する可能性があります。", "INT4, 자동 Group 및 recurrent 제어 투영 BF16을 사용해 MLX + GGUF 생성을 가속합니다. 실험 기능이며 정확도에 큰 영향을 줄 수 있습니다."],
    ["本次啟動已使用快速GGUF模式。", "Fast GGUF mode is enabled for this launch.", "今回の起動では高速 GGUF モードを使用しています。", "이번 실행에는 빠른 GGUF 모드를 사용합니다."],
    ["本次啟動未使用快速GGUF模式。", "Fast GGUF mode is not enabled for this launch.", "今回の起動では高速 GGUF モードを使用していません。", "이번 실행에는 빠른 GGUF 모드를 사용하지 않습니다."],
    ["僅適用於 mlx-server 載入 GGUF。", "Only available when mlx-server loads a GGUF model.", "mlx-server で GGUF を読み込む場合にのみ使用できます。", "mlx-server가 GGUF를 로드할 때만 사용할 수 있습니다."],
    ["已開啟；採用 INT4、自動 Group，並將 recurrent 控制投影保留為 BF16。", "Enabled; uses INT4 and automatic grouping while retaining recurrent control projections as BF16.", "有効です。INT4 と自動 Group を使用し、recurrent 制御投影は BF16 のまま保持します。", "활성화됨; INT4와 자동 Group을 사용하고 recurrent 제어 투영은 BF16으로 유지합니다."],
    ["預設採用較保守的 INT8 與 Group 32。", "The default uses more conservative INT8 and Group 32 settings.", "既定では、より保守的な INT8 と Group 32 を使用します。", "기본값은 더 보수적인 INT8 및 Group 32를 사용합니다."],
    ...
    ["搜尋 Repository", "Search repositories", "Repository を検索", "Repository 검색"],
    ["關閉搜尋", "Close search", "検索を閉じる", "검색 닫기"],
    ["搜尋關鍵字", "Search keyword", "検索キーワード", "검색 키워드"],
    ["輸入模型名稱或關鍵字", "Enter a model name or keyword", "モデル名またはキーワードを入力", "모델 이름 또는 키워드 입력"],
    ["搜尋", "Search", "検索", "검색"],
    ["搜尋中…", "Searching…", "検索しています…", "검색 중…"],
    ["依目前模型格式篩選搜尋結果；Revision 固定使用 main。", "Results are filtered by the current model format; Revision is fixed to main.", "現在のモデル形式で検索結果を絞り込みます。Revision は main に固定されます。", "현재 모델 형식으로 검색 결과를 필터링하며 Revision은 main으로 고정됩니다."],
    ["輸入關鍵字後搜尋 Hugging Face Repository。", "Enter a keyword to search Hugging Face repositories.", "キーワードを入力して Hugging Face Repository を検索します。", "키워드를 입력하여 Hugging Face Repository를 검색하세요."],
    ["請輸入搜尋關鍵字", "Enter a search keyword", "検索キーワードを入力してください", "검색 키워드를 입력하세요"],
    ["正在搜尋 Hugging Face Repository…", "Searching Hugging Face repositories…", "Hugging Face Repository を検索しています…", "Hugging Face Repository를 검색하는 중…"],
    ["找到 Repository", "Repositories found", "見つかった Repository", "찾은 Repository"],
    ["找不到符合的 Repository。", "No matching repositories found.", "一致する Repository が見つかりません。", "일치하는 Repository를 찾지 못했습니다."],
    ["Repository 搜尋失敗", "Repository search failed", "Repository の検索に失敗しました", "Repository 검색 실패"],
    ["排序", "Sort", "並び順", "정렬"],
    ["下載數", "Downloads", "ダウンロード数", "다운로드 수"],
    ["讚數", "Likes", "いいね数", "좋아요 수"],
    ["字母", "Alphabetical", "アルファベット", "알파벳"],
    ["已選用 Repository", "Repository selected", "Repository を選択しました", "Repository 선택됨"],
    ["選用", "Select", "選択", "선택"],
    ["已選用", "Selected", "選択済み", "선택됨"],
    ["次下載", "downloads", "ダウンロード", "다운로드"],
    ["個讚", "likes", "件のいいね", "좋아요"],
    ["更新於", "Updated", "更新", "업데이트"],
    ...
    ["請先輸入 Repository", "Enter a repository first", "先に Repository を入力してください", "먼저 Repository를 입력하세요"],
    ["正在掃描 GGUF 檔案…", "Scanning GGUF files…", "GGUF ファイルをスキャンしています…", "GGUF 파일을 검색하는 중…"],
    ["找不到可下載的 GGUF 主模型檔案", "No downloadable primary GGUF model files found", "ダウンロード可能なメイン GGUF モデルが見つかりません", "다운로드할 수 있는 기본 GGUF 모델 파일을 찾지 못했습니다"],
    ["無法載入 GGUF 檔案清單", "Unable to load the GGUF file list", "GGUF ファイル一覧を読み込めません", "GGUF 파일 목록을 불러올 수 없습니다"],
    ["重新掃描 GGUF 檔案", "Rescan GGUF files", "GGUF ファイルを再スキャン", "GGUF 파일 다시 검색"],
    ["GGUF 檔案清單已更新", "GGUF file list updated", "GGUF ファイル一覧を更新しました", "GGUF 파일 목록을 업데이트했습니다"],
    ["會掃描 Repository 的主 GGUF 檔案並預選 Q4_0；下載前也會尋找配對的 mmproj 與 DFlash Draft。", "Scans the repository for primary GGUF files and preselects Q4_0. Matching mmproj and DFlash Draft files are also discovered before download.", "Repository のメイン GGUF ファイルをスキャンして Q4_0 を事前選択します。ダウンロード前に対応する mmproj と DFlash Draft も検索します。", "Repository의 기본 GGUF 파일을 검색하고 Q4_0을 미리 선택합니다. 다운로드 전에 일치하는 mmproj 및 DFlash Draft도 검색합니다."],
    ["加入最愛", "Add to favorites", "お気に入りに追加", "즐겨찾기에 추가"],
    ["已加入最愛", "Added to favorites", "お気に入りに追加済み", "즐겨찾기에 추가됨"],
    ["加入我的最愛", "Add to My Favorites", "お気に入りに追加", "내 즐겨찾기에 추가"],
    ["我的最愛", "My Favorites", "お気に入り", "내 즐겨찾기"],
    ["尚未加入常用模型。", "No favorite models yet.", "お気に入りのモデルはまだありません。", "아직 즐겨찾기 모델이 없습니다."],
    ["已加入我的最愛", "Added to My Favorites", "お気に入りに追加しました", "내 즐겨찾기에 추가했습니다"],
    ["從我的最愛移除", "Remove from My Favorites", "お気に入りから削除", "내 즐겨찾기에서 제거"],
    ["確定要從我的最愛移除嗎？", "Remove this entry from My Favorites?", "この項目をお気に入りから削除しますか？", "이 항목을 내 즐겨찾기에서 제거하시겠습니까?"],
    ["已從我的最愛移除", "Removed from My Favorites", "お気に入りから削除しました", "내 즐겨찾기에서 제거했습니다"],
    ...
    ["開啟 MLX 模型目錄", "Open MLX model folder", "MLX モデルフォルダーを開く", "MLX 모델 폴더 열기"],
    ["開啟 GGUF 模型目錄", "Open GGUF model folder", "GGUF モデルフォルダーを開く", "GGUF 모델 폴더 열기"],
    ["僅能在 Tanpopo 本機桌面介面使用", "Available only in the local Tanpopo desktop app", "ローカルの Tanpopo デスクトップ画面でのみ使用できます", "로컬 Tanpopo 데스크톱 화면에서만 사용할 수 있습니다"],
    ...
    ["確定要清除本機儲存的 Access Token？需要時必須重新輸入。", "Clear the locally saved Access Token? You will need to enter it again when required.", "ローカルに保存された Access Token を消去しますか？必要な場合は再入力してください。", "로컬에 저장된 Access Token을 지울까요? 필요할 때 다시 입력해야 합니다."],
    ["Access Token 已清除", "Access Token cleared", "Access Token を消去しました", "Access Token을 지웠습니다"],
    ["儲存設定", "Save settings", "設定を保存", "설정 저장"],
    ["正在儲存…", "Saving…", "保存中…", "저장 중…"],
    ["設定已自動儲存", "Settings saved automatically", "設定を自動保存しました", "설정을 자동으로 저장했습니다"],
    ["啟用登入驗證前，請先填寫新密碼與確認密碼，再開啟此開關。", "Enter and confirm a new password before turning sign-in authentication on.", "ログイン認証を有効にする前に、新しいパスワードと確認用パスワードを入力してください。", "로그인 인증을 켜기 전에 새 비밀번호와 확인 비밀번호를 입력하세요."],
    ...
    ["模型來源與設定", "Model sources and settings", "モデル取得元と設定", "모델 소스 및 설정"],
    ["Hugging Face、模型功能與效能校準", "Hugging Face, model features and performance calibration", "Hugging Face、モデル機能と性能校正", "Hugging Face, 모델 기능 및 성능 보정"],
    ["手動比較模型配置，保存最佳結果供後續啟動套用。", "Manually compare model configurations and save the best result for later launches.", "モデル設定を手動で比較し、最良の結果を次回以降の起動用に保存します。", "모델 설정을 수동으로 비교하고 최적 결과를 이후 시작 시 적용하도록 저장합니다."],
    ["啟用效能校準", "Enable performance calibration", "性能校正を有効化", "성능 보정 활성화"],
    ["預設開啟。在執行狀態按「效能校準」可複選模型，自動選擇適用的 Server；無須事先載入模型。每個模型比較 3 組配置、每組測試 3 次，保存中位數最佳的配置。不會自動開始測試；關閉後不再套用已保存的校準結果。", "Enabled by default. Use Calibrate performance on the Runtime page to select multiple models and automatically choose compatible servers; no model needs to be loaded first. Each model compares three configurations with three runs each and saves the best median. Tests never start automatically. Disabling this feature stops applying saved calibration results.", "既定で有効です。実行状態の「性能校正」で複数のモデルを選び、対応する Server を自動選択します。事前読み込みは不要です。各モデルで 3 つの設定を各 3 回測定し、中央値が最良の設定を保存します。テストは自動開始しません。無効にすると保存済みの校正結果を適用しなくなります。", "기본적으로 켜져 있습니다. 실행 상태에서 성능 보정을 눌러 여러 모델을 선택하면 호환 Server가 자동 선택됩니다. 미리 모델을 로드할 필요가 없습니다. 모델마다 설정 3개를 각각 3회 측정하고 중앙값이 가장 좋은 설정을 저장합니다. 테스트는 자동으로 시작하지 않습니다. 끄면 저장된 보정 결과를 적용하지 않습니다."],
    ["儲存效能校準設定", "Save calibration settings", "校正設定を保存", "보정 설정 저장"],
    ["效能校準設定已保存", "Calibration settings saved", "校正設定を保存しました", "보정 설정을 저장했습니다"],
    ["Runtime 保護", "Runtime protection", "Runtime の保護", "Runtime 보호"],
    ["僅在明確啟用後生效；保護偏好會保存在本機設定。", "Takes effect only when explicitly enabled. Protection preferences are saved locally.", "明示的に有効化した場合のみ動作し、保護設定はローカルに保存されます。", "명시적으로 활성화한 경우에만 동작하며 보호 설정은 로컬에 저장됩니다."],
    ...
    ["實驗性功能", "Experimental features", "実験的機能", "실험적 기능"],
    ["可能改變檔案與儲存行為", "May change file and storage behavior", "ファイルと保存動作が変わる可能性があります", "파일 및 저장 동작이 달라질 수 있습니다"],
    ["這些選項會改變 GGUF 轉換完成後的檔案保留方式，請先確認已有可重新取得的來源。", "These options change which files are kept after GGUF conversion. Make sure the source can be obtained again.", "これらの設定は GGUF 変換後に保持するファイルを変更します。元ファイルを再取得できることを確認してください。", "이 옵션은 GGUF 변환 후 보관할 파일을 변경합니다. 원본을 다시 받을 수 있는지 먼저 확인하세요."],
    ["轉換後移除原 GGUF", "Remove original GGUF after conversion", "変換後に元の GGUF を削除", "변환 후 원본 GGUF 제거"],
    ["Fast GGUF 完整建立或從既有檔案成功載入，且模型服務正常後，才移除本次使用的原始 GGUF。預設關閉；模型服務停止後，必須重新取得原始 GGUF 才能再次載入或改用 llama.cpp。", "The source GGUF used for this launch is removed only after Fast GGUF is fully created or successfully loaded from existing files and the model service is healthy. Disabled by default. After the model service stops, the original GGUF must be obtained again before the model can be loaded or used with llama.cpp.", "Fast GGUF が完全に作成されるか既存ファイルから正常に読み込まれ、モデルサービスも正常になった後にのみ、今回使用した元の GGUF を削除します。既定はオフです。モデルサービス停止後に再び読み込む場合や llama.cpp を使う場合は、元の GGUF を再取得する必要があります。", "Fast GGUF가 완전히 생성되거나 기존 파일에서 성공적으로 로드되고 모델 서비스도 정상일 때만 이번 실행에 사용한 원본 GGUF를 제거합니다. 기본값은 꺼짐입니다. 모델 서비스가 중지된 후 다시 로드하거나 llama.cpp를 사용하려면 원본 GGUF를 다시 받아야 합니다."],
    ["Runtime 保護與校準", "Runtime protection and calibration", "Runtime の保護と校正", "Runtime 보호 및 보정"],
    ["僅在明確啟用後生效；校準資料與保護偏好會保存在本機設定。", "These features take effect only when explicitly enabled. Calibration data and protection preferences are stored locally.", "明示的に有効化した場合のみ動作し、校正データと保護設定はローカルに保存されます。", "명시적으로 활성화한 경우에만 동작하며 보정 데이터와 보호 설정은 로컬에 저장됩니다."],
    ["自動效能校準", "Automatic performance calibration", "自動性能校正", "자동 성능 보정"],
    ["效能校準", "Calibrate performance", "性能校正", "성능 보정"],
    ["校準中…", "Calibrating…", "校正中…", "보정 중…"],
    ["載入模型後，可手動校準效能；校準期間模型服務會重啟數次。", "After loading a model, you can manually calibrate performance. The model service restarts several times during calibration.", "モデルの読み込み後、手動で性能を校正できます。校正中はモデルサービスが数回再起動します。", "모델을 로드한 후 수동으로 성능을 보정할 수 있습니다. 보정 중 모델 서비스가 여러 번 재시작됩니다."],
    ["模型載入完成後即可校準。", "Calibration is available once the model has loaded.", "モデルの読み込み完了後に校正できます。", "모델 로드가 완료되면 보정할 수 있습니다."],
    ["無可用的效能校準設定", "No performance calibration settings are available", "利用可能な性能校正設定がありません", "사용 가능한 성능 보정 설정이 없습니다"],
    ["自動效能校準目前未啟用", "Automatic performance calibration is not enabled", "自動性能校正が有効になっていません", "자동 성능 보정이 활성화되지 않았습니다"],
    ["啟用後，按「效能校準」可複選模型，預設勾選目前模型。每個模型比較 3 組配置、每組測試 3 次，保存中位數最佳的配置。已載入且配置相同時直接測試，切換模型或配置時才重新載入；不會在首次啟動時自動校準，預設關閉。", "When enabled, Calibrate performance lets you select multiple models, with the current model selected by default. Each model compares three configurations with three runs each and saves the best median. Loaded models with matching configurations are reused; only model or configuration changes require reloading. Calibration never starts automatically on first launch. Disabled by default.", "有効にすると「性能校正」で複数のモデルを選択でき、現在のモデルが既定で選択されます。各モデルで 3 つの設定を各 3 回測定し、中央値が最良の設定を保存します。読み込み済みで設定が同じ場合は再利用し、モデルや設定の変更時のみ再読み込みします。初回起動時の自動校正は行いません。既定はオフです。", "활성화하면 성능 보정에서 여러 모델을 선택할 수 있으며 현재 모델이 기본 선택됩니다. 모델마다 설정 3개를 각각 3회 측정하고 중앙값이 가장 좋은 설정을 저장합니다. 이미 로드되어 설정이 같은 모델은 재사용하며 모델이나 설정을 바꿀 때만 다시 로드합니다. 첫 시작 시 자동 보정하지 않습니다. 기본값은 꺼짐입니다."],
    ["選擇要校準的模型", "Select models to calibrate", "校正するモデルを選択", "보정할 모델 선택"],
    ["可複選，預設勾選目前選取的模型。各模型比較 3 組配置，每組測試 3 次。", "Select multiple models; the current selection is checked by default. Each model compares three configurations with three runs each.", "複数選択できます。現在選択中のモデルが既定でチェックされます。各モデルで 3 つの設定を各 3 回測定します。", "여러 모델을 선택할 수 있으며 현재 선택한 모델이 기본 체크됩니다. 모델마다 설정 3개를 각각 3회 측정합니다."],
    ["已載入且配置相同時直接測試；只有切換模型或配置時才重新載入。完成後回到原模型，有校準結果時套用建議配置。", "Loaded models with matching configurations are tested directly. Reloading occurs only when changing models or configurations. On completion, return to the original model and apply its recommendation when available.", "読み込み済みで設定が同じ場合はそのまま測定し、モデルや設定の変更時のみ再読み込みします。完了後は元のモデルに戻り、校正結果があれば推奨設定を適用します。", "이미 로드되어 설정이 같은 모델은 바로 측정하며 모델이나 설정을 바꿀 때만 다시 로드합니다. 완료 후 원래 모델로 돌아가 보정 결과가 있으면 권장 설정을 적용합니다."],
    ["測試進度", "Test progress", "テスト進捗", "테스트 진행 상황"],
    ["單次測試未提供即時百分比時，進度列以進行中呈現；完成後打勾。", "When a test provides no live percentage, its progress bar shows ongoing activity. Completed tests receive a checkmark.", "個別テストでリアルタイムの割合が提供されない場合、進捗バーは実行中を示します。完了後にチェックを表示します。", "개별 테스트가 실시간 비율을 제공하지 않으면 진행 막대는 실행 중으로 표시됩니다. 완료하면 체크 표시가 나타납니다."],
    ["校準結果與建議配置", "Calibration results and recommendations", "校正結果と推奨設定", "보정 결과 및 권장 설정"],
    ["依每組 3 次測試的中位數選出最佳配置；中位數相同時比較平均值。各模型分別比較，不跨模型排名。", "The best configuration is selected by the median of three runs, with the average as a tie-breaker. Comparisons are per model, never across models.", "各設定の 3 回の中央値で最良の設定を選び、同値の場合は平均値で比較します。モデルごとに比較し、モデル間の順位付けはしません。", "각 설정의 3회 측정 중앙값으로 최적 설정을 선택하고 동률이면 평균값을 비교합니다. 모델별로 비교하며 모델 간 순위는 매기지 않습니다."],
    ["開始校準", "Start calibration", "校正を開始", "보정 시작"],
    ["可直接開啟並選擇要校準的模型，不必事先載入。", "Open directly and select models to calibrate; no model needs to be loaded first.", "モデルを事前に読み込まずに、校正画面を開いてモデルを選択できます。", "모델을 미리 로드하지 않고 보정 창을 열어 모델을 선택할 수 있습니다."],
    ["可複選；已有載入的模型會預先勾選，未載入時不預選。各模型比較 3 組配置，每組測試 3 次。", "Select multiple models. Only an already loaded model is checked by default; otherwise nothing is selected. Each model compares three configurations with three runs each.", "複数選択できます。読み込み済みのモデルのみ既定でチェックされ、未読み込みの場合は何も選択されません。各モデルで 3 つの設定を各 3 回測定します。", "여러 모델을 선택할 수 있습니다. 이미 로드된 모델만 기본 체크되며 로드된 모델이 없으면 아무것도 선택되지 않습니다. 모델마다 설정 3개를 각각 3회 측정합니다."],
    ["已載入且配置相同時直接測試；只有切換模型或配置時才重新載入。完成後回到原模型並套用建議配置；原先未載入時，則恢復未載入狀態。", "Loaded models with matching configurations are tested directly. Reload only when changing models or configurations. On completion, restore the original model with its recommendation, or return to the unloaded state if no model was loaded initially.", "読み込み済みで設定が同じ場合はそのまま測定し、モデルや設定の変更時のみ再読み込みします。完了後は元のモデルに推奨設定を適用して戻します。開始時に未読み込みの場合は未読み込み状態に戻します。", "이미 로드되어 설정이 같은 모델은 바로 측정하며 모델이나 설정을 변경할 때만 다시 로드합니다. 완료 후 원래 모델에 권장 설정을 적용하고, 처음에 로드된 모델이 없었다면 미로드 상태로 복원합니다."],
    ["啟用後，無須先載入模型即可按「效能校準」複選模型，並自動選擇適用的 Server。僅預先勾選已載入的模型，未載入時不預選。每個模型比較 3 組配置、每組測試 3 次，保存中位數最佳的配置；不會在首次啟動時自動校準，預設關閉。", "When enabled, open Calibrate performance without first loading a model, select multiple models, and let the app choose a compatible server. Only a loaded model is selected by default. Each model compares three configurations with three runs each and saves the best median. Calibration does not start automatically on first launch. Disabled by default.", "有効にすると事前読み込みなしで「性能校正」を開き、複数のモデルを選択して対応する Server を自動選択できます。読み込み済みのモデルのみ既定で選択します。各モデルで 3 つの設定を各 3 回測定し、中央値が最良の設定を保存します。初回起動時の自動校正は行いません。既定はオフです。", "활성화하면 모델을 미리 로드하지 않고 성능 보정을 열어 여러 모델을 선택하면 호환되는 Server가 자동 선택됩니다. 로드된 모델만 기본 선택됩니다. 모델마다 설정 3개를 각각 3회 측정하고 중앙값이 가장 좋은 설정을 저장합니다. 첫 시작 시 자동 보정하지 않으며 기본값은 꺼짐입니다."],
    ["自動依模型選擇適用的 Server 與啟動配置。", "Automatically choose a compatible server and launch configuration for each model.", "モデルごとに対応する Server と起動設定を自動選択します。", "모델별로 호환되는 Server와 시작 설정을 자동 선택합니다."],
    ["沒有適用的 Server 或啟動配置", "No compatible server or launch configuration", "対応する Server または起動設定がありません", "호환되는 Server 또는 시작 설정이 없습니다"],
    ["正在恢復未載入狀態…", "Returning to the unloaded state…", "未読み込み状態に戻しています…", "미로드 상태로 복원 중…"],
    ["校準完成，結果已保存並恢復未載入狀態。", "Calibration completed; results saved and the unloaded state restored.", "校正が完了し、結果を保存して未読み込み状態に戻しました。", "보정이 완료되어 결과를 저장하고 미로드 상태로 복원했습니다."],
    ["Runtime 預設", "Runtime default", "Runtime の既定値", "Runtime 기본값"],
    ["配置", "Configuration", "設定", "설정"],
    ["未執行", "Not run", "未実行", "실행 안 함"],
    ["目前已載入配置", "Currently loaded configuration", "現在読み込み済みの設定", "현재 로드된 설정"],
    ["目前設定", "Current setting", "現在の設定", "현재 설정"],
    ["實體核心／Batch 512", "Physical cores / Batch 512", "物理コア／Batch 512", "물리 코어 / Batch 512"],
    ["邏輯核心／Batch 1024", "Logical cores / Batch 1024", "論理コア／Batch 1024", "논리 코어 / Batch 1024"],
    ["實體核心／Batch 1536", "Physical cores / Batch 1536", "物理コア／Batch 1536", "물리 코어 / Batch 1536"],
    ["測試 1", "Run 1", "測定 1", "측정 1"],
    ["測試 2", "Run 2", "測定 2", "측정 2"],
    ["測試 3", "Run 3", "測定 3", "측정 3"],
    ["建議配置", "Recommended configuration", "推奨設定", "권장 설정"],
    ["相較第一組配置", "Compared with the first configuration", "最初の設定との比較", "첫 번째 설정 대비"],
    ["已保存，後續啟動自動套用", "Saved; applied automatically on later launches", "保存済み。次回以降の起動時に自動適用", "저장됨. 이후 시작 시 자동 적용"],
    ["結果尚未保存", "Results not saved", "結果は未保存です", "결과가 저장되지 않음"],
    ["已選模型", "Selected models", "選択したモデル", "선택한 모델"],
    ["已選模型（全部格式）", "Selected models (all formats)", "選択したモデル（全形式）", "선택한 모델(모든 형식)"],
    ["全部", "All", "すべて", "전체"],
    ["目前沒有此格式的模型。", "No models of this format are available.", "この形式のモデルはありません。", "이 형식의 모델이 없습니다."],
    ["校準需要先建立 Fast GGUF；此模型已略過", "Calibration requires Fast GGUF to be created first; this model was skipped", "校正には Fast GGUF の作成が必要です。このモデルをスキップしました", "보정하려면 먼저 Fast GGUF를 생성해야 합니다. 이 모델을 건너뛰었습니다"],
    ["執行狀態已變更，請重新開啟校準視窗。", "The runtime state changed. Reopen the calibration dialog.", "実行状態が変わりました。校正画面を開き直してください。", "실행 상태가 변경되었습니다. 보정 창을 다시 여세요."],
    ["正在恢復原模型並套用建議配置…", "Restoring the original model and applying its recommendation…", "元のモデルを復元して推奨設定を適用中…", "원래 모델을 복원하고 권장 설정을 적용하는 중…"],
    ["校準完成，部分模型未完成，請查看結果。", "Calibration finished with incomplete models. Review the results.", "一部のモデルが未完了のまま校正が終了しました。結果を確認してください。", "일부 모델의 보정이 완료되지 않았습니다. 결과를 확인하세요."],
    ["校準完成，結果已保存並恢復原模型。", "Calibration completed; results saved and the original model restored.", "校正が完了し、結果を保存して元のモデルを復元しました。", "보정이 완료되어 결과를 저장하고 원래 모델을 복원했습니다."],
    ["記憶體壓力保護", "Memory pressure protection", "メモリ負荷保護", "메모리 압력 보호"],
    ["啟動前依模型、Context、KV Cache 與可用記憶體估算；必要時先降低 Context 與 Batch／Prefill，仍不足才停用 MTP／DFlash。沒有安全組合時會拒絕啟動；預設關閉。", "Before launch, estimates memory from the model, context, KV cache, and available memory. It first reduces Context and Batch/Prefill, and disables MTP/DFlash only if still necessary. Launch is rejected if no safe combination exists. Disabled by default.", "起動前にモデル、Context、KV Cache、空きメモリから使用量を見積もります。必要に応じて Context と Batch／Prefill を先に下げ、それでも不足する場合のみ MTP／DFlash を無効化します。安全な組み合わせがない場合は起動を拒否します。既定はオフです。", "시작 전에 모델, Context, KV Cache 및 사용 가능한 메모리로 사용량을 추정합니다. 필요하면 먼저 Context와 Batch/Prefill을 낮추고, 그래도 부족할 때만 MTP/DFlash를 끕니다. 안전한 조합이 없으면 시작을 거부합니다. 기본값은 꺼짐입니다."],
    ["已套用自動效能校準", "Automatic performance calibration applied", "自動性能校正を適用しました", "자동 성능 보정을 적용했습니다"],
    ["記憶體壓力保護已調整啟動參數", "Memory pressure protection adjusted the launch parameters", "メモリ負荷保護が起動パラメータを調整しました", "메모리 압력 보호가 시작 매개변수를 조정했습니다"],
    ["自動效能校準完成，已套用最佳設定", "Automatic performance calibration completed; the best setting is now applied", "自動性能校正が完了し、最良の設定を適用しました", "자동 성능 보정이 완료되어 최적 설정을 적용했습니다"],
    ["恢復原啟動設定失敗", "Failed to restore the original launch settings", "元の起動設定を復元できませんでした", "원래 시작 설정을 복원하지 못했습니다"],
    ["直接載入模式不會執行自動效能校準", "Automatic performance calibration is skipped in direct-load mode", "直接読み込みモードでは自動性能校正を実行しません", "직접 로드 모드에서는 자동 성능 보정을 실행하지 않습니다"],
    ["已降低 Batch／Prefill 以減少啟動尖峰記憶體", "Batch/Prefill was reduced to lower peak launch memory", "起動時のピークメモリを抑えるため Batch／Prefill を下げました", "시작 시 최대 메모리를 줄이기 위해 Batch/Prefill을 낮췄습니다"],
    ["可用記憶體不足，已停用 MTP／DFlash", "MTP/DFlash was disabled because available memory is insufficient", "空きメモリが不足しているため MTP／DFlash を無効化しました", "사용 가능한 메모리가 부족하여 MTP/DFlash를 껐습니다"],
    ["Context 已由", "Context reduced from", "Context を", "Context를"],
    ["降為", "to", "から", "에서"],
    ["儲存實驗性設定", "Save experimental settings", "実験設定を保存", "실험 설정 저장"],
    ["啟用後，Fast GGUF 成功載入且模型服務正常時，原始 GGUF 會從硬碟永久移除。確定要啟用？", "When enabled, the original GGUF is permanently removed from disk after Fast GGUF loads successfully and the model service is healthy. Enable this setting?", "有効にすると、Fast GGUF が正常に読み込まれ、モデルサービスが正常になった時点で、元の GGUF はディスクから完全に削除されます。有効にしますか？", "활성화하면 Fast GGUF가 성공적으로 로드되고 모델 서비스가 정상일 때 원본 GGUF가 디스크에서 영구적으로 제거됩니다. 이 설정을 켜시겠습니까?"],
    ["實驗性設定已保存", "Experimental settings saved", "実験設定を保存しました", "실험 설정을 저장했습니다"],
    ["模型功能預設", "Model feature defaults", "モデル機能の既定値", "모델 기능 기본값"],
    ["控制選擇模型時套用的初始功能；進階設定仍可針對本次啟動手動調整。", "Control the initial features applied when a model is selected. Advanced settings can still override them for the current launch.", "モデル選択時に適用する初期機能を設定します。詳細設定では今回の起動に限って上書きできます。", "모델 선택 시 적용할 초기 기능을 설정합니다. 고급 설정에서 이번 실행에 한해 다시 조정할 수 있습니다."],
    ["快速 GGUF 策略", "Fast GGUF strategy", "高速 GGUF 戦略", "빠른 GGUF 전략"],
    ["設定 mlx-server 載入 GGUF 時套用的預設轉換策略；原生 MLX 與 llama-server 不受影響。", "Set the default conversion strategy used when mlx-server loads GGUF. Native MLX and llama-server are unaffected.", "mlx-server が GGUF を読み込むときに適用する既定の変換戦略を設定します。ネイティブ MLX と llama-server には影響しません。", "mlx-server가 GGUF를 불러올 때 적용할 기본 변환 전략을 설정합니다. 네이티브 MLX와 llama-server에는 영향을 주지 않습니다."],
    ["轉換策略", "Conversion strategy", "変換戦略", "변환 전략"],
    ["Mode 1（均衡 · 預設）", "Mode 1 (Balanced · Default)", "Mode 1（バランス · 既定）", "Mode 1 (균형 · 기본)"],
    ["Mode 2（較高精度）", "Mode 2 (Higher accuracy)", "Mode 2（高精度）", "Mode 2 (더 높은 정확도)"],
    ["Mode 3（最快）", "Mode 3 (Fastest)", "Mode 3（最速）", "Mode 3 (가장 빠름)"],
    ["預設", "Default", "既定", "기본"],
    ["快速GGUF模式預設開啟", "Enable Fast GGUF mode by default", "高速 GGUF モードを既定で有効化", "빠른 GGUF 모드를 기본으로 켜기"],
    ["選擇 mlx-server 的 GGUF 模型時自動開啟；關閉後改用一般 GGUF 轉換。", "Automatically enables Fast GGUF when a GGUF model is selected for mlx-server. When disabled, standard GGUF conversion is used.", "mlx-server で GGUF モデルを選択したときに自動で有効化します。無効時は通常の GGUF 変換を使用します。", "mlx-server에서 GGUF 모델을 선택하면 자동으로 켭니다. 끄면 일반 GGUF 변환을 사용합니다."],
    ["啟用快速GGUF模式預設", "Enable the Fast GGUF default", "高速 GGUF の既定値を有効化", "빠른 GGUF 기본값 켜기"],
    ["儲存快速 GGUF 策略", "Save Fast GGUF strategy", "高速 GGUF 戦略を保存", "빠른 GGUF 전략 저장"],
    ["快速 GGUF 策略已保存", "Fast GGUF strategy saved", "高速 GGUF 戦略を保存しました", "빠른 GGUF 전략을 저장했습니다"],
    ["KV Cache 量化預設開啟", "Enable KV Cache quantization by default", "KV Cache 量子化を既定で有効化", "KV Cache 양자화를 기본으로 켜기"],
    ["選擇模型時自動開啟；量化格式仍由啟動參數決定，且不會與 DFlash 同時啟用。", "Automatically enables it when a model is selected. The quantization format still comes from launch arguments, and it is never enabled together with DFlash.", "モデル選択時に自動で有効化します。量子化形式は引き続き起動引数で決まり、DFlash とは同時に有効化されません。", "모델 선택 시 자동으로 켭니다. 양자화 형식은 실행 인자로 결정되며 DFlash와 동시에 켜지지 않습니다."],
    ["啟用 KV Cache 量化預設", "Enable the KV Cache quantization default", "KV Cache 量子化の既定値を有効化", "KV Cache 양자화 기본값 켜기"],
    ["MMap 預設開啟", "Enable MMap by default", "MMap を既定で有効化", "MMap을 기본으로 켜기"],
    ["選擇模型時自動開啟權重檔案映射；實際效果取決於模型格式與儲存裝置。", "Automatically enables weight-file mapping when a model is selected. Actual behavior depends on the model format and storage device.", "モデル選択時に重みファイルのマッピングを自動で有効化します。実際の動作はモデル形式とストレージによります。", "모델 선택 시 가중치 파일 매핑을 자동으로 켭니다. 실제 동작은 모델 형식과 저장 장치에 따라 달라집니다."],
    ["啟用 MMap 預設", "Enable the MMap default", "MMap の既定値を有効化", "MMap 기본값 켜기"],
    ["DFlash 預設開啟", "Enable DFlash by default", "DFlash を既定で有効化", "DFlash를 기본으로 켜기"],
    ["僅在模型支援且找到配對 Draft 模型時自動開啟；不會與 KV Cache 量化同時啟用。", "Automatically enables it only when the model supports DFlash and a matching Draft model is available. It is never enabled together with KV Cache quantization.", "DFlash 対応モデルで対応する Draft モデルが見つかった場合にのみ自動で有効化し、KV Cache 量子化とは同時に有効化しません。", "DFlash를 지원하고 일치하는 Draft 모델이 있을 때만 자동으로 켭니다. KV Cache 양자화와 동시에 켜지지 않습니다."],
    ["啟用 DFlash 預設", "Enable the DFlash default", "DFlash の既定値を有効化", "DFlash 기본값 켜기"],
    ["儲存功能預設", "Save feature defaults", "機能の既定値を保存", "기능 기본값 저장"],
    ["功能預設已保存", "Feature defaults saved", "機能の既定値を保存しました", "기능 기본값을 저장했습니다"],
    ...
    ["技術報告", "Technical reports", "技術レポート", "기술 보고서"],
    ["模型相容性報告", "Model compatibility report", "モデル互換性レポート", "모델 호환성 보고서"],
    ["效能與精確度報告", "Performance and accuracy report", "性能・精度レポート", "성능 및 정확도 보고서"],
    ...
    ["透過 ZIP 更新", "Update from ZIP", "ZIP から更新", "ZIP으로 업데이트"],
    ["上傳與更新中…", "Uploading and updating…", "アップロードして更新中…", "업로드 및 업데이트 중…"],
    ["請選擇 Tanpopo 發布 ZIP。更新期間服務會短暫中斷，完成後將自動重新啟動。", "Select a Tanpopo release ZIP. The service will briefly stop during the update and restart automatically when complete.", "Tanpopo のリリース ZIP を選択してください。更新中はサービスが一時停止し、完了後に自動的に再起動します。", "Tanpopo 릴리스 ZIP을 선택하세요. 업데이트 중 서비스가 잠시 중단되며 완료 후 자동으로 다시 시작됩니다."],
    ["確定要上傳並套用這個 ZIP 更新嗎？", "Upload and apply this ZIP update?", "この ZIP 更新をアップロードして適用しますか？", "이 ZIP 업데이트를 업로드하고 적용할까요?"],
    ["正在上傳並驗證更新 ZIP…", "Uploading and validating the update ZIP…", "更新 ZIP をアップロードして検証しています…", "업데이트 ZIP을 업로드하고 확인하는 중…"],
    ["更新程序已啟動，正在準備安裝。", "The update has started and is preparing the installation.", "更新処理を開始し、インストールを準備しています。", "업데이트가 시작되어 설치를 준비하고 있습니다."],
    ["更新套件已驗證，正在準備安裝。", "The update package was verified and is being prepared.", "更新パッケージを検証し、インストールを準備しています。", "업데이트 패키지 확인이 완료되어 설치를 준비하고 있습니다."],
    ["正在安裝更新套件與 Runtime。", "Installing the update package and Runtime.", "更新パッケージと Runtime をインストールしています。", "업데이트 패키지와 Runtime을 설치하고 있습니다."],
    ["更新已準備完成，正在重新啟動服務。", "The update is ready. Restarting the service.", "更新の準備が完了しました。サービスを再起動しています。", "업데이트 준비가 완료되어 서비스를 다시 시작하는 중입니다."],
    ["ZIP 更新完成，服務已重新啟動。", "ZIP update completed and the service restarted.", "ZIP 更新が完了し、サービスを再起動しました。", "ZIP 업데이트가 완료되어 서비스가 다시 시작되었습니다."],
    ["正在等待服務完成更新並重新啟動…", "Waiting for the service to finish updating and restart…", "サービスの更新完了と再起動を待っています…", "서비스 업데이트 완료 및 재시작을 기다리는 중…"],
    ["ZIP 更新完成，即將重新載入頁面。", "ZIP update completed. Reloading the page…", "ZIP 更新が完了しました。ページを再読み込みします…", "ZIP 업데이트가 완료되었습니다. 페이지를 다시 불러옵니다…"],
    ["ZIP 更新失敗", "ZIP update failed", "ZIP 更新に失敗しました", "ZIP 업데이트 실패"],
    ["請選擇 ZIP 檔案", "Select a ZIP file", "ZIP ファイルを選択してください", "ZIP 파일을 선택하세요"],
    ...
    ["平均生成速度", "Average generation speed", "平均生成速度", "평균 생성 속도"],
    ["中位生成速度", "Median generation speed", "生成速度の中央値", "생성 속도 중앙값"],
    ["測試時間", "Test duration", "テスト時間", "테스트 시간"],
    ["重複 3 次測試", "Run 3 tests", "3 回繰り返しテスト", "3회 반복 테스트"],
    ["長輸出測試", "Long-output test", "長文出力テスト", "긴 출력 테스트"],
    ["正在進行重複測試", "Running repeated test", "繰り返しテストを実行中", "반복 테스트 실행 중"],
    ["正在進行長輸出測試（至少 500 Tokens）…", "Running long-output test (at least 500 tokens)…", "長文出力テストを実行中（500 Tokens 以上）…", "긴 출력 테스트 실행 중(최소 500 Tokens)…"],
    ["已完成 3 次效能測試", "Completed 3 performance tests", "3 回の性能テストが完了しました", "성능 테스트 3회 완료"],
    ["長輸出測試完成", "Long-output test completed", "長文出力テストが完了しました", "긴 출력 테스트 완료"],
    ["長輸出測試未達 500 Tokens", "Long-output test produced fewer than 500 tokens", "長文出力テストが 500 Tokens に達しませんでした", "긴 출력 테스트가 500 Tokens에 도달하지 못했습니다"],
    ["Runtime 未回傳完整的速度資料", "The Runtime did not return complete speed data", "Runtime から完全な速度データが返されませんでした", "Runtime이 완전한 속도 데이터를 반환하지 않았습니다"],
    ["關閉視窗", "Close", "閉じる", "닫기"],
